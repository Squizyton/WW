...
public class UI : MonoBehaviour {
	...
	void OnGUI(){
		...
		GUI.Box(new Rect(Screen.width * 0.1f, 0, Screen.width*(0.35f*(FirstCurHp/FirstPHp)), Screen.height * 0.06f),"  ");
		...
		GUI.Box(new Rect(Screen.width * 0.1f, Screen.height*0.06f, Screen.width*(0.35f*(FirstCurMa/FirstPMa)), Screen.height * 0.04f),"  ");
		GUI.Box(new Rect(0,Screen.height*0.1f,Screen.width*0.05f,Screen.height*0.35f), "SP: "+Mathf.RoundToInt(FirstCurSt)+"/"+FirstPSt);
		GUI.Box(new Rect(0,Screen.height*0.1f,Screen.width*0.05f,Screen.height*(0.35f*(FirstCurSt/FirstPSt))), "  ");
		...
		GUI.Box(new Rect(Screen.width*0.55f+(Screen.width*(0.35f*(1-(SecondCurHp/SecondPHp)))),0,Screen.width*(0.35f*(SecondCurHp/SecondPHp)),Screen.height*0.06f), "  ");
		GUI.Box(new Rect(Screen.width*0.55f ,Screen.height*0.06f,Screen.width*0.35f,Screen.height*0.04f), "MP: "+ SecondCurMa+"/"+SecondPMa);
		GUI.Box(new Rect(Screen.width*0.55f+(Screen.width*(0.35f*(1-(SecondCurMa/SecondPMa)))),Screen.height*0.06f,Screen.width*(0.35f*(SecondCurMa/SecondPMa)),Screen.height*0.04f), "  ");
		GUI.Box(new Rect(Screen.width*0.95f ,Screen.height*0.1f,Screen.width*0.05f,Screen.height*0.35f), "SP: "+SecondCurSt+"/"+SecondPSt);
		GUI.Box(new Rect(Screen.width*0.95f ,Screen.height*0.1f,Screen.width*0.05f,Screen.height*(0.35f*(SecondCurSt/SecondPSt))), "  ");
